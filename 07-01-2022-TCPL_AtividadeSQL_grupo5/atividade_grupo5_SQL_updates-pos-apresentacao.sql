...
(default,'TAINA CAMPOS','TAINADEPP@HOTMAIL.COM','11988776644','RUA CINCO',55,'HOGSMEAD','SÃO PAULO','SP','TO BE INCLUDED',2500.00,4000.00,'BRASILEIRO'),
...
-- Retornando o registro com menor salário mínimo de acordo com o nome e limitando a 1 retorno, para trazer apenas uma linha caso haja salarios minimos iguais;
select * from tab_ficha_profissional
